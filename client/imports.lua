...
function TriggerServerCallback(name, cb, ...)
	...
	TriggerServerEvent('azakit_scrapaircon:triggerServerCallback', name, CurrentRequestId, ...)
...
RegisterNetEvent('azakit_scrapaircon:serverCallback')
AddEventHandler('azakit_scrapaircon:serverCallback', function(requestId, ...)
